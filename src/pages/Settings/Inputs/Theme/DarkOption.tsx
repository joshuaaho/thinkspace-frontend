...
const DarkOption = ({ isSelected }: ThemeOptionProps) => {
  const { setValue } = useFormContext<EditUserCommand>();

  return (
    <button
      type="button"
      onClick={() => setValue("themePreference", ThemePreference.Dark)}
    ...
    >
      <div className="flex flex-col items-center gap-3">
        <MdDarkMode className="w-12 h-12 text-info" />
        <div className="text-center">
          <h3 className="font-semibold text-base-content">Dark</h3>
